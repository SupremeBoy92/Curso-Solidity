...
interface IERC20 {
    ...
    function transferencia_telemedicina(address cliente, address to, uint256 amount) external returns(bool);
...
contract ERC20Basic is IERC20 {
    ...
    string public constant symbol = "TLMC";
    ...
    function transferencia_telemedicina(address _cliente, address to, uint256 numTokens) public override returns(bool) {
        // Comprobamos que el emisor tiene tokens en su cartera
